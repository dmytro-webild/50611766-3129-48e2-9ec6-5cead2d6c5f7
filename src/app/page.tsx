...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/delicious-pita-near-meal-vegetables_23-2148132004.jpg",
          alt: "Delicious pita near meal",
        },
        {
          src: "http://img.b2bpic.net/free-photo/top-view-appetizing-pozole-bowl_23-2149248560.jpg",
          alt: "Appetizing pozole bowl",
        },
        {
          src: "http://img.b2bpic.net/free-photo/mexican-meal_23-2148159765.jpg",
          alt: "Traditional Mexican meal",
        },
        {
          src: "http://img.b2bpic.net/free-photo/hand-holding-cup-garnish-with-nacho-near-mexican-food_23-2148181569.jpg",
          alt: "Hand holding garnish",
        },
        {
          src: "http://img.b2bpic.net/free-photo/people-enjoying-mexican-barbecue_23-2151000309.jpg",
          alt: "People enjoying barbecue",
        },
      ]}
      marqueeItems={[
        {
      ...
      features={[
        {
          ...
          subtitle: "Hand-crafted cocktails",
          category: "Drinks",
          value: "Freshly made",
        },
        {
          id: "f2",
          title: "Traditional Menudo",
          subtitle: "Authentic comfort food",
          category: "Soup",
          value: "Slow cooked",
        },
        {
  ...
  <div id="menu" data-section="menu">
      ...
      products={[
        {
          id: "p1",
          name: "Beef Enchilada & Chile Relleno",
          price: "$18",
          variant: "Popular",
        ...
        },
        {
          ...
          price: "$12",
          variant: "Classic",
          imageSrc: "http://img.b2bpic.net/free-photo/adding-syrup-indi-lemon-grapefruit-cocktail_114579-3121.jpg",
        },
        {
          id: "p3",
          name: "Traditional Menudo",
          price: "$15",
          variant: "Authentic",
          imageSrc: "http://img.b2bpic.net/free-photo/top-view-appetizing-pozole-bowl_23-2149248629.jpg",
        },
        {
          id: "p4",
          name: "Taco de Alambres",
          price: "$16",
          variant: "Favorite",
          imageSrc: "http://img.b2bpic.net/free-photo/side-view-alcohol-cocktail-with-almond-lime-wooden-board_140725-12772.jpg",
        },
        {
          id: "p5",
          ...
          price: "$17",
          variant: "Sizzling",
          imageSrc: "http://img.b2bpic.net/free-photo/beef-burrito-with-rice_1147-392.jpg",
        },
        {
          id: "p6",
          name: "Shrimp Cocktail Soup",
          price: "$19",
          variant: "Fresh",
          imageSrc: "http://img.b2bpic.net/free-photo/chicken-curry-black-cup_1150-23797.jpg",
        },
      ]}
  ...
  <div id="reviews" data-section="reviews">
      ...
      testimonials={[
        ...
        },
        {
          ...
          quote: "Excellent dinner place, great flavor and still attended by the owners.",
          name: "David K.",
          role: "Reviewer",
        ...
        },
        {
          id: "r5",
          title: "Perfect Lunch",
          quote: "Found this place near my office, service was fast, atmosphere was neat and clean.",
          name: "Sarah J.",
          role: "Local Professional",
          imageSrc: "http://img.b2bpic.net/free-photo/annoyed-young-female-gardener-uniform-wearing-gardening-hat-holds-broken-pepper_141793-115677.jpg",
        },
      ]}
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        ...
        },
        {
          ...
          content: "Yes, we offer delivery through our website and popular apps.",
        },
        {
          id: "q3",
          title: "Are you family-owned?",
          content: "Yes, Casa Flores is proudly family-owned and operated.",
        },
      ]}
  ...
  <div id="contact" data-section="contact">
      ...
      buttons={[
        ...
        {
          text: "Get Directions",
          href: "https://maps.google.com/?q=1032+E+Hammer+Ln+B+Stockton+CA+95210",
        },
      ]}
    />
  </div>
